    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient(){
            public void onReceivedError(WebView webView, int errorCode, String description, String fallingUrl){
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(TermsAndCondition.this).create();
                ...
                alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Ok", (dialogInterface, i) -> {
                    finish();
                    Intent intent1 = new Intent(TermsAndCondition.this, MainActivity.class);
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                try{
                    ...
                    Toast.makeText(TermsAndCondition.this, "No Activity Found....", Toast.LENGTH_SHORT).show();
                }
                if (url.contains(".pdf")){
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    ...
                    try {
                        ...
                        Toast.makeText(TermsAndCondition.this, "No pdf view installed", Toast.LENGTH_SHORT).show();
                    }
                }
                return true;
            }
        ...
        if(savedInstanceState == null){
            webView.post(() -> webView.loadUrl(Links.TC));
        }
        ...
        webView.setDownloadListener((url, userAgent, contentDisposition, mimeType, contentLength) -> {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
                if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
                    ...
                    ActivityCompat.requestPermissions(TermsAndCondition.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                }
            }
            else{
                Log.v(TAG, "Permission Granted");
